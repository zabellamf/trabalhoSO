...
namespace Grafica
{
    class Pedidos
    {
        ...
        public String Getcliente() { return this.cliente1; }
        public float GetTotal() { return this.total; }
        public int GetPrazo() { return this.prazo1; }
        public float GetPreco() { return this.preco; }
        public void SetNome(String cliente1) { this.cliente1 = cliente1; }
        public void SetTotal(int total) { this.total = total; }
        public void Setpreco(float preco) { this.preco = preco; }
        public void SetPrazo(int prazo1) { this.prazo1 = prazo1; }
